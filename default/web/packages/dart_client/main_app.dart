...
@CustomTag('main-app')
class MainApp extends PolymerElement with ChangeNotifier  {

  /// Constructor used to create instance of MainApp.
  MainApp.created() : super.created();

  @reflectable @observable List get greetings => __$greetings; List __$greetings; @reflectable set greetings(List value) { __$greetings = notifyPropertyChange(#greetings, __$greetings, value); }
